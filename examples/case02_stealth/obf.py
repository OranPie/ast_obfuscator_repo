...
class _o0:
    ...
    def __init__(_o1, _o2: _oc):
        (lambda _o, _n, _v: (lambda _f, _a, _k: _f(*_a, **_k))(_ob, (_o, _n, _v), {}))(_o1, 'owner', _o2)
        _o1.balance = 345 - 345 + 0

    def deposit(_o1, _o3: int) -> 0 if 924 == 943 else None:
        _o1.balance += _o3

    def withdraw(_o1, _o3: _o9) -> _o6:
        if _o3 > _o1.balance:
            return -1469 + 6042 == 11703 ^ 15437
        _o1.balance -= _o3
        return _o6(10248 - 318 + 0 ^ (31566 ^ 23941))

    def snapshot(_o1) -> dict:
        return {_obf_call(_obf_str, (-268 + 268, ((29241 ^ 29305, (1241 + -1194, 499 - 444 + 0, 651 - 605 + 0, 591 - 554 + 0, -1832 + 1882)),)), {}): (lambda _f, _a, _k: _f(*_a, **_k))(_obf_call(__import__, ('operator',), {}).attrgetter((lambda _f, _a, _k: _f(*_a, **_k))(''.join, (('o', 'w', 'n', 'e', 'r'),), {})), (_o1,), {}), _obf_str(5752 ^ 5754, 'ecnalab'): _o1.balance, _obf_str(227 - 227 + 0, ((-1382 + 1452, (-2129 + 2170, -4286 + 4331)),)): _o1.balance >= -940 + 940}

def _o4() -> (lambda: None)():
    _o5 = _o0(_obf_str(599 - 599 + 0, ((720 - 497 + 0, (410 ^ 295,)), (6001 ^ 6011, (179 - 78 + 0,)), (20625 ^ 20690, (385 - 352 + 0,)))))
    _o5.deposit(-289 + 319)
    __import__('operator').attrgetter(''.join((chr(_c) for _c in (17207 ^ 17216, 23839 ^ 23926, -1115 + 1231, 13157 ^ 13069, 659 - 559 + 0, 950 - 836 + 0, -1736 + 1833, 617 + -498))))(_o5)(12849 ^ 12854)
    _oa(_obf_call(_obf_call(__import__, ('operator',), {}).attrgetter((lambda _f, _a, _k: _f(*_a, **_k))(''.join, (('s', 'n', 'a', 'p', 's', 'h', 'o', 't'),), {}))(_o5), (), {}))
